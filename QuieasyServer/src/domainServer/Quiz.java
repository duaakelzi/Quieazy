...
public class Quiz  {
    ...
    public Quiz(String quiz_Name, int threshold, boolean isPublic, boolean deleted) { //deleted??
        super();
    ...
    public Quiz(Long id, String quiz_Name, int threshold, boolean isPublic, boolean deleted, Set<Question> question) {
        super();
        this.id = id;
        this.quiz_Name = quiz_Name;
        this.threshold = threshold;
